...
export default function App() {
  ...
  return <main className="shell"><header><div className="brand"><span><Utensils size={17} /></span>오늘 뭐 먹지?</div><small>학교 급식 한눈에 보기</small></header>
    <section className="hero"><div><p>NEIS SCHOOL MEAL</p><h1>이번 주,<br /><em>맛있는</em> 계획.</h1><label>우리 학교의 점심 메뉴를<br />간단하게 확인해 보세요.</label></div><div className="doodle">오늘의<br />점심을<br /><b>찾아볼까요?</b><br /><span className="doodle-arrow">↓</span></div></section>
